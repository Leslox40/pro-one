  ...
  return (
    ...
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Abonnez-vous pour recevoir les mises à jour futures.
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Rejoignez notre newsletter pour recevoir les dernières actualités sur nos services et produits.
      </p>
      <form>
        <input
          type="text"
        ...
        <p className="text-center text-base font-medium leading-relaxed text-body-color">
          Aucun spam garanti, veuillez donc ne pas envoyer de courrier indésirable.
        </p>
      </form>
